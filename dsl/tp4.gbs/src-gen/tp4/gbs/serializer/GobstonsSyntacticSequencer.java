...
public class GobstonsSyntacticSequencer extends AbstractSyntacticSequencer {

	protected GobstonsGrammarAccess grammarAccess;
	...
	protected void init(IGrammarAccess access) {
		grammarAccess = (GobstonsGrammarAccess) access;
